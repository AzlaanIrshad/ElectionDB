<template>
  <div class="homepage bg-gray-100 font-sans">
    ...
    <!-- Categories Section -->
    <section class="categories py-10 mb-10 bg-white rounded-lg shadow-xl mt-10 mx-2 lg:mx-5">
    ...
    <!-- News Section -->
    <section class="news py-12 bg-white rounded-lg shadow-xl mx-2 lg:mx-5 mb-10">
