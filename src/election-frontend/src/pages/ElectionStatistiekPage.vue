<template>
  <div class="flex flex-col md:flex-row h-screen">
    ...
    <div class="flex-1 p-4 md:p-6 overflow-y-auto">
      ...
      <div v-else-if="activeTab === 'Partij Zetels'">
        <PartySeats :partySeats="partySeats" />
      </div>
    </div>
  </div>
</template>
...
import PartySeats from "@/components/PartySeats.vue";

export default {
  name: "ElectionStatistiekPage",
  components: { ElectionMap, ElectionDonutChart, PartySeats },
  data() {
    return {
