            ...
            <div class="flex items-center my-2">
              <!-- Like Icon (SVG) and Count -->
                <div class="flex flex-col items-center mr-4">
                  <svg v-if="likeCount < 0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mb-1 size-6">
                  ...
                  <span class="text-xs text-gray-500 dark:text-gray-400">{{ likeCount }}</span>
                </div>
