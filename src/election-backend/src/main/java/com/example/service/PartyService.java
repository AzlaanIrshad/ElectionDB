...
public class PartyService {
    ...
    public Map<String, Object> getPartyResults(String partyId, List<Integer> years) {
        ...
        for (Integer year : years) {
            ...
            try (InputStream partyInputStream = new ClassPathResource(partyFilePath).getInputStream();
                ...
                resultsByYear.put(year.toString(), "Error: Unable to find results file for year " + year + ".");
            }
        }
